...
const commands = [
    ...
    new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                .setName("canal")
                .setDescription(
                    "Escolha um canal já cadastrado (autocompletar)",
                )
                .setRequired(true)
                .setAutocomplete(true),
        ),
    new SlashCommandBuilder()
        ...
        .setDescription(
            "Escolher cargo para ser atribuído quando o streamer estiver ao vivo",
        )
        .addStringOption((option) =>
            option
                .setName("streamer")
                .setDescription(
                    "Nome do streamer (precisa já estar no /adicionar)",
                )
                .setRequired(true)
                .setAutocomplete(true),
        )
